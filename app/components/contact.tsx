        ...
        <div className='w-full h-auto text-center bg-black py-2 flex flex-col justify-center items-center'>
            ...
            <div>
                <form className='rounded px-8 pt-6 pb-8 mb-4' onSubmit={sendMail}>
                    ...
                    <input value={subject} onChange={(e) => setSubject(e.target.value)} className='shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline' type='text' placeholder='Subject' />
                    <br /><br />
                    <label className="block text-gray-700 text-sm font-bold mb-2">Message</label>
                    <textarea value={message} onChange={(e) => setMessage(e.target.value)} className='shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline' placeholder='Message' />
                    <br /><br />
